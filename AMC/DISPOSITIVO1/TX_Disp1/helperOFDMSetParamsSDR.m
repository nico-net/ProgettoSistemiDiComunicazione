function [sysParam,txParam,payload] = helperOFDMSetParamsSDR(OFDMParam,dataParam, messageSent)
...
%
% Imposta la struttura dei parametri condivisi tra tx/rx
sysParam = struct();

% Imposta la struttura dei parametri specifici della trasmissione
