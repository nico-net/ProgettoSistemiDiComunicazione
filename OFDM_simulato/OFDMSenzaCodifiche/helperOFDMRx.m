...
[modOrder, ~, fftLength,...
    modName] = OFDMHeaderUnpack(headerBits);
...
function [modOrder,fftLenIndex,fftLength,modType] = OFDMHeaderUnpack(inBits)
...
function [headerBits] = OFDMHeaderRecovery(headSymb,sysParam)
