function [radioTx,spectrumAnalyze] = helperGetRadioTxObj(ofdmTx)
...
radioTx = sdrtx('Pluto');
radioTx.BasebandSampleRate = ofdmTx.SampleRate;
radioTx.CenterFrequency = ofdmTx.CenterFrequency;
radioTx.Gain  = ofdmTx.Gain;
